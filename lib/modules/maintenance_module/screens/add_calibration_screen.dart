          ...
          child: ListView(
            children: [
              ...
              Row(
                children: [
                  Text(
                      'Calibration Date: ${_calibrationDate.toString().substring(0, 10)}'),
                  SizedBox(width: 16),
                  ElevatedButton(
                    onPressed: () async {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      final newCalibration = CalibrationRecord(
        id: DateTime.now()
            .toString(), // You might want to use a more robust ID generation method
      ...
      Provider.of<CalibrationProvider>(context, listen: false)
          .addCalibrationRecord(newCalibration);
