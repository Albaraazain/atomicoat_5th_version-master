...
class _RecipeDetailScreenState extends State<RecipeDetailScreen>
    ...
    if (widget.recipeId != null) {
      ...
      if (recipe != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text('Recipe not found'), backgroundColor: Colors.red),
        );
      }
    }
  }
  ...
  Widget _buildSetParameterEditor(RecipeStep step) {
    ...
    SystemComponent? selectedComponent = step.parameters['component'] != null
        ? availableComponents
            .firstWhere((c) => c.name == step.parameters['component'])
        : null;
          ...
          onChanged: (value) {
            setState(() {
              ...
              step.parameters['parameter'] =
                  null; // Reset parameter when component changes
              step.parameters['value'] =
                  null; // Reset value when component changes
            });
          },
        ...
        _buildDropdown<String>(
          ...
          onChanged: (value) {
            setState(() {
              ...
              step.parameters['value'] =
                  null; // Reset value when parameter changes
            });
          },
        ),
        SizedBox(height: 16),
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ...
              ListTile(
                leading:
                    Icon(Icons.arrow_forward, color: DarkThemeColors.accent),
                title: Text('Valve',
                    style: TextStyle(color: DarkThemeColors.primaryText)),
                onTap: () {
                  Navigator.pop(context);
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _addStep(
                      StepType.setParameter, parentStep?.subSteps ?? _steps);
                },
              ),
            ],
          ),
      ...
      switch (type) {
        ...
        case StepType.setParameter:
          ...
          final availableComponents =
              systemStateProvider.components.values.toList();
          if (availableComponents.isNotEmpty) {
            ...
            steps.add(RecipeStep(
              ...
              parameters: {
                ...
                'parameter': availableParameters.isNotEmpty
                    ? availableParameters.first
                    : null,
                'value': null,
              },
            ));
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                  content: Text('No components available to set parameters.')),
            );
          }
          break;
      }
