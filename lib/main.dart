    ...
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
            create: (context) =>
                SafetyErrorProvider(context.read<AuthService>())),
        ChangeNotifierProvider(
        ...
        ChangeNotifierProxyProvider4<RecipeProvider, AlarmProvider,
          ...
          update: (context, recipeProvider, alarmProvider,
