...
class _AdminDashboardScreenState extends State<AdminDashboardScreen>
              ...
              return FutureBuilder<UserRole?>(
                ...
                builder: (context, roleSnapshot) {
                  if (roleSnapshot.connectionState == ConnectionState.waiting) {
                    return ListTile(
                        title: Text(user.name), subtitle: Text('Loading...'));
                  }
  ...
  void _approveUser(UserRequest request) async {
    await _userRequestRepository.updateUserRequestStatus(
        request.userId, UserRequestStatus.approved);
  ...
  void _denyUser(UserRequest request) async {
    await _userRequestRepository.updateUserRequestStatus(
        request.userId, UserRequestStatus.denied);
